...
const bookImage1 = "@/../public/assets/img/giftsandcallings.jpg";
const bookImage2 = "@/../public/assets/img/systems_structures.jpg";
const bookImage3 = "@/../public/assets/img/work_of_ministry.jpg";
