...
export default function Nav(){
    return(
        <div className="nav flex font-[Lato]">
            ...
            <Select name="status" className="border-spacing-1 rounded-2xl text-sm py-[0.5rem] bg-[#c1d1b5] text-black font-light border-solid border-2 border-gray-500 pl-3 "aria-label="Location">
                <option value="active" >W 630 S2 #130, Beautiful Gate</option>
                <option value="paused">Salt Lake City, US</option>
                <option value="delayed">Kasoa, Ghana WA</option>
                <option value="canceled">Calabar, Cross River State, NG, WA</option>
            </Select>
            </div>
            </div>
